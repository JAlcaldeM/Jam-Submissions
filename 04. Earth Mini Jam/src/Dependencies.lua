...
gFonts = {
    ...
    --['description'] = love.graphics.newFont('fonts/04B30.ttf', 17),
    ['description2'] = love.graphics.newFont('fonts/upheavtt.ttf', 20),
    ['arcade'] = love.graphics.newFont('fonts/ArcadeClassic.ttf', 14),
...
gTextures = {
  --['levelup'] = love.graphics.newImage('graphics/levelup.png'),
